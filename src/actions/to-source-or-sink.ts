...
/**
 * Given an option value `optionValue` that purports to identify LR or a
 * one-indexed mix, determine whether it refers to one.  If it does, return
 * either `LR` or the zero-indexed value of the mix.  If not, log an error and
 * return null.
 *
 * @param instance
 *   The active module instance.
